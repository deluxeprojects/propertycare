      ...
      <div className="relative">
        ...
        {loading && query.length >= 2 && (
          <span className="absolute right-9 top-1/2 -translate-y-1/2 text-xs text-muted-foreground">
            <svg className="inline h-3.5 w-3.5 animate-spin text-accent" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  ...
                  {results.services.map((s) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="shrink-0 text-xs font-semibold text-accent">AED {s.base_price_aed}</span>
                      </Link>
                    );
                  })}
                </div>
