            ...
            >
              {service.image_url ? (
                ...
                <div className="mb-3 -mx-6 -mt-6 flex h-32 items-center justify-center rounded-t-xl bg-gradient-to-br from-accent/5 to-accent/10">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-accent-text/30" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <div className="mb-2 flex items-center gap-2">
                ...
                {service.is_featured && (
                  <span className="rounded-full bg-accent/10 px-2 py-0.5 text-[10px] font-semibold text-accent-text">Popular</span>
                )}
              ...
              <h3 className="mb-2 text-lg font-semibold text-card-foreground group-hover:text-accent-text">
                {service.name_en}
              </h3>
              ...
              {service.service_variants && service.service_variants.length > 0 ? (
                <div className="space-y-1">
                  ...
                  {service.service_variants.length > 3 && (
                    <p className="text-xs text-accent-text">+{service.service_variants.length - 3} more sizes</p>
                  )}
                </div>
              ) : (
